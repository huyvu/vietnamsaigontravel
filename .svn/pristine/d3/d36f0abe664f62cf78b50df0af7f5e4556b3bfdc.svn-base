        ...
        <tr>
            <td colspan="2" style="background:#f5f5f5;margin:0;padding:0 10px;margin:0">
                <p>Your booking information has been sent to Palm Vietnam Travel and is pedding. To complete the booking you must pay a deposit of <b style="color:#f00">(209 USD)</b> by click the <b>‘Check out with Paypal’</b> button below to Payment safely with Paypal.
                    <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; If you’ve not received a reply within 48 business hours please email <a href="mailto:info@palmvietnamtravel.com" title="Email">info@palmvietnamtravel.com</a>, you may also email us at this address to provide feedback on our services.</p>
                <p style="display:block;text-align:center;padding:15px 0">
                    <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&amp;no_note=may&amp;no_shipping=1&amp;currency_code=USD&amp;notify_url=&amp;amount=104.5&amp;business=hongdiep@palmvietnam.com&amp;item_name=Payment booking tour&amp;vpc_orderid=115.77.138.115&amp;quantity=2&amp;rm=2&amp;return_url=www.palmvietnamtravel.com&amp;cancel_url=www.palmvietnamtravel.com&amp;BUTTONSOURCE=Peacesoft_Channel_EC_VN"><img src="http://www.palmvietnamtravel.com/template/Default/images/btn_depositEmail.png">
                    </a>
                </p>
