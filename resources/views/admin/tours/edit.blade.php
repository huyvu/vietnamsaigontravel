			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<input type="hidden" name="destinations" id="list-destination" value="{{ !empty($tour->destinations)?destination_decode($tour->destinations, ''):'' }}">
					</div>
					<div class="form-group-separator"></div>
					<div class="form-group">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="form-group start-tour" style="{{$tour->day_tour == 0?'display:none':''}}">
							...
							<div class="col-sm-8">
								<input type="text" name="day_tour_start_time" class="form-control" placeholder="7:00 AM" value="{{ $tour->day_tour_start_time }}">
							</div>
						</div>
